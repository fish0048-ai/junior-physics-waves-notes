...
本倉庫是國中八年級理化講義網站（第 3 章波動、第 4 章光、第 5 章溫度與熱、第 6 章探索物質組成、實驗專區）。

上傳新章時：不刪內容、用探究教學統整、對齊第 4 章，產出章首、各節、段考、章末評量。活動紀錄本／實驗專區以**步驟**為主軸（一格一步），**不要**練習、段考前練習、章末評量。目前章節含第 3～6 章與實驗專區。
...
7. `.cursor/skills/junior-physics-notes/labs.md` — 實驗專區（步驟為主）
